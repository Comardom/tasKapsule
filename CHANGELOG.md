# 更新
## [2026-09-17] - 0.3.11
* 基础全局样式中加入了去掉按钮padding的规则
* 基础全局样式中加入了去掉文字段落margin的规则
* 修复了复制按钮产生冒泡的bug
* 修复了一个全局CSS选择器层级问题
* 修复了部分gsap调用语法问题
* 稍微调整控制按钮的样式
...
## [2026-09-10] - 0.3.5
* 给门内的按钮提供了悬停说明
* 重写了README.md，加入了DEV.md
* 修正了package.json中dev指令的bug
* 删除了已经无用的.task和bin文件夹
...
---
## [2026-06-17] - 0.2.0
* 修复了切换到双列的Promise丢弃问题
* 修复了后端部分报错不明确的问题
* 更新了相关文档

---
## [2026-06-17] - 0.1.42
* 加入了Cell的粘着高亮和头尾自动处理高亮

---
## [2026-06-17] - 0.1.41
* 再次修改CalendarBody的点击格子的月份判定

---
## [2026-06-17] - 0.1.40
* 修改CalendarBody的点击格子的月份判定
